...
Ещё одна проблема markdown в том, что его проблематично экспортировать в LaTeX. Конечно можно через pandoc, но вычищать его потом можно замучиться. А мне хочется ещё и pdf версии статей делать с его помощью. А вот AsciiDoc такое может.
